...
echo
red "Внимание: номер версии можно посмотреть на https://github.com/SagerNet/sing-box/tags, и там должна быть надпись Downloads (обязательно версия серии 1.10 или версии 1.30 и выше)"
...
green "Формат номера тестовой версии: цифра.цифра.цифра-alpha или rc или beta.цифра (пример: 1.13.0-alpha или rc или beta.1)"
...
yellow "3：Отправить актуальную конфигурацию узлов (опция 1+опция 2) в уведомление Telegram"
yellow "0：Вернуться на уровень выше"
readp "Выберите【0-3】：" menu
if [ "$menu" = "1" ]; then
sbshare
